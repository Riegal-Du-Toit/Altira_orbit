...
async function runMigration() {
  ...
  try {
    ...
    const brokers = [
      { code: 'DAY1', name: 'Altira Orbit Direct', broker_commission_rate: 0, branch_commission_rate: 0, agent_commission_rate: 0, policy_prefix: 'DAY1', member_count: 996, status: 'active' },
      ...
      { code: 'D1NAV', name: 'Altira Navigator', broker_commission_rate: 5, branch_commission_rate: 2, agent_commission_rate: 1, policy_prefix: 'NAV', member_count: 381, status: 'active' },
