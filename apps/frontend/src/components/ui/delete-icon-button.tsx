...
export function DeleteIconButton({ onClick, label }: DeleteIconButtonProps) {
  return (
    <button
      type="button"
      className="group relative flex h-[31px] w-[31px] flex-col items-center justify-center overflow-hidden rounded-md border border-red-800 bg-red-400 hover:bg-red-600"
      onClick={(event) => { event.stopPropagation(); onClick(); }}
      aria-label={label}
    >
      <svg viewBox="0 0 1.625 1.625" className="absolute -top-4 fill-white delay-100 group-hover:top-3 group-hover:animate-[spin_1.4s] group-hover:duration-1000" height="9" width="9">
      ...
      <svg width="9" fill="none" viewBox="0 0 39 7" className="origin-right duration-500 group-hover:rotate-90">
      ...
      <svg width="9" fill="none" viewBox="0 0 33 39">
        <mask fill="white" id="delete-bin-mask">
          <path d="M0 0H33V35C33 37.2091 31.2091 39 29 39H4C1.79086 39 0 37.2091 0 35V0Z" />
        </mask>
        <path mask="url(#delete-bin-mask)" fill="white" d="M0 0H33H0ZM37 35C37 39.4183 33.4183 43 29 43H4C-0.418278 43 -4 39.4183 -4 35H4H29H37ZM4 43C-0.418278 43 -4 39.4183 -4 35V0H4V35V43ZM37 0V35C37 39.4183 33.4183 43 29 43V35V0H37Z" />
